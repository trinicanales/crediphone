...
export function FormularioCotizacion({ onClose }: FormularioCotizacionProps) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 max-w-md w-full">
      ...
      <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">
        Dejanos tus datos y nos pondremos en contacto contigo por WhatsApp
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={4}
            placeholder="En que productos estas interesado? Necesitas un plan de financiamiento?"
